          ...
          {props.launcherIcon
            ...
            : (
              <svg width="28" height="28" viewBox="0 0 32 32" fill="none" aria-hidden="true">
                <rect x="4" y="8" width="24" height="17" rx="6" fill="currentColor"/>
                <ellipse cx="12" cy="15.5" rx="2.8" ry="3.5" fill="var(--cbl-primary, #0066FF)"/>
                <path d="M19 14.5 Q22 11.5 25 14.5" stroke="var(--cbl-primary, #0066FF)" strokeWidth="2" strokeLinecap="round" fill="none"/>
                <path d="M11 21 Q16 24.5 21 21" stroke="var(--cbl-primary, #0066FF)" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
                <path d="M16 0.5 L17.5 4 L21 5.5 L17.5 7 L16 10.5 L14.5 7 L11 5.5 L14.5 4 Z" fill="currentColor"/>
              </svg>
            )}
        </button>
      )}
